      ...
      "categories": [
        {
          ...
          "type": "docs",
          "items": [
            { "text": "護照 & 護照影本", "desc": "正本效期需6個月以上；影本備用" },
            { "text": "身份證 & 駕照正本+日文譯本", "desc": "若要自駕必備譯本 (非國際駕照)" },
            { "text": "Visit Japan Web (VJW)", "desc": "【必備】填寫入境/海關申報，截圖 QR Code" },
            { "text": "機票/住宿/保險證明", "desc": "建議列印紙本或存手機備查" },
            { "text": "紙、筆", "desc": "填寫入境卡或紀錄隨身用" }
          ]
        },
        {
          "title": "金融與通訊 (隨身)",
          "type": "finance",
          "items": [
            { "text": "現金 (外幣/台幣)", "desc": "日幣現金用於拉麵機、老店、儲值交通卡" },
            { "text": "信用卡 (2-3張)", "desc": "推薦 JCB 匯率優；Visa/Master 備用" },
            { "text": "SIM 卡卡針 & 網卡", "desc": "換卡必備工具，下飛機前更換" },
            { "text": "手機吊繩", "desc": "雪地防手滑掉落雪堆找不到" }
          ]
        },
        {
          "title": "衣物與保暖戰略 (Winter Gear)",
          "type": "winter",
          "note": "北海道室內外溫差極大，請採「洋蔥式穿搭」",
          "items": [
            { "text": "可拆式冰爪 (Ice Cleats)", "desc": "【CSV缺漏補充】北海道路面結冰必備，避免滑倒受傷" },
            { "text": "發熱衣、褲 (Heattech)", "desc": "內層核心保暖，建議多帶幾套替換" },
            { "text": "毛帽、圍巾、手套", "desc": "手套建議選「可觸控螢幕」款" },
            { "text": "厚襪子 (羊毛襪)", "desc": "腳底保暖最重要，建議多帶" },
            { "text": "內衣褲、睡衣、換洗衣服", "desc": "飯店通常有暖氣，睡衣可選輕薄" },
            { "text": "口罩", "desc": "防寒防風，也能保濕呼吸道" },
            { "text": "暖暖包 (手握/貼式)", "desc": "貼式貼在後腰或腳底非常有效" },
            { "text": "太陽眼鏡", "desc": "雪地反光強烈，保護眼睛" }
          ]
        },
        {
          "title": "醫藥與個人護理 (Personal)",
          "type": "daily",
          "items": [
            { "text": "常備藥品", "desc": "過敏藥、腸胃藥、止痛藥、感冒藥" },
            { "text": "外傷急救", "desc": "OK繃、酸痛貼布 (走路多必備)" },
            { "text": "保濕與清潔", "desc": "護唇膏、護手霜、乳液 (日本極乾)、棉花棒、牙線" },
            { "text": "盥洗用品", "desc": "牙刷牙膏、洗髮精/護髮、刮鬍刀" },
            { "text": "隱形眼鏡/眼鏡", "desc": "食鹽水記得帶 (日本藥妝店也可買)" },
            { "text": "防曬乳液", "desc": "雪地紫外線強烈需防曬" }
          ]
        },
        {
          "title": "電子與生活雜物 (Gadgets)",
          "type": "daily",
          "items": [
            { "text": "行動電源", "desc": "低溫掉電快，請隨身攜帶" },
            { "text": "充電組 (頭/線/手錶線)", "desc": "日本電壓100V，插頭與台灣相同 (雙扁孔)" },
            { "text": "一對多插頭 / 轉接頭", "desc": "飯店插座可能不夠，延長線很實用" },
            { "text": "行李秤", "desc": "回程控制重量避免超重" },
            { "text": "折疊購物袋", "desc": "日本塑膠袋收費，隨身帶一個" },
            { "text": "雨傘 / 輕便雨衣", "desc": "防濕雪或臨時降雨" },
            { "text": "無痕膠帶", "desc": "封箱或臨時修補用" },
            { "text": "濕紙巾 / 衛生紙", "desc": "隨身清潔" }
          ]
        },
        {
          "title": "📱 實用 APP 推薦",
